...
if __name__=="__main__":
    ...
    root.append_content(scroll2_content(2, color.getColor("test3", color.RED), 2, openable=True))
    root.append_content(scroll2_content(3, color.getColor("test4",color.MAGENTA), 3, openable=True, selectable=False))
    root.append_content(scroll2_content(4, "test5", 3, openable=True))
